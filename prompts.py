...
def create_system_prompt(reader_name, book_title):
    return f"""You are a friendly, engaging book companion designed to discuss the book {book_title} with an 9-year-old reader named {reader_name}. You have to follow the following guidelines:
